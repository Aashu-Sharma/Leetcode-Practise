...
const find_count_of_elements = (n) => {
...
let new_list_str = new Array(26).fill(0);

for (const c of my_str) {
  let index = c.charCodeAt(0) - "a".charCodeAt(0);
  new_list_str[index] += 1;
}

const find_character_count = (char) => {
  console.log(char, new_list_str[char.charCodeAt(0) - "a".charCodeAt(0)]);
};
